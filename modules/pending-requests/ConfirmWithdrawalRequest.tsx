...
import { withdrawalQuery } from '@helpers/api-queries';
...
export default function ConfirmWithdrawalRequest(){
    ...
    const updateWithdrawalRequest = useMutation((data: any) => {
        return api(Method.PUT, `${withdrawalRequestMutation}/${selected['form_no']}`, data) as AxiosPromise<any>;
    });
    ...
    const handleSaveRequest = async() => {
      // selected['remarks'] = remarks;
        await updateWithdrawalRequest.mutate(selected, {
    ...
    return (
        ...
        {/* <ActionAlert show={showAlert} close={handleCloseAlert} action={action} /> */ }
            ...
            <ConfirmRequestDialog
                ...
                request={"confirm"}
                action={"continue"}
                isLoading={updateWithdrawalRequest.isLoading}
            />
            <RequestDetails 
