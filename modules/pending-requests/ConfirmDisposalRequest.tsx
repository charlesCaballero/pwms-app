...
export default function ConfirmDisposalRequest(){
    ...
    const updateDisposalRequest = useMutation((data: any) => {
        return api(Method.PUT, `${disposalRequestMutation}/${selected['form_no']}`, data) as AxiosPromise<any>;
    });
        ...
        {/* <ActionAlert show={showAlert} close={handleCloseAlert} action={action} /> */ }
            ...
            <Grid item>
                <Box sx={ { display: 'flex', m: '20px' } } justifyContent = "center">
                    <DataTable
                        header={ tableHeader }
                        dataQuery = { url + "/" + disposalQuery + '/pending'
                        }
