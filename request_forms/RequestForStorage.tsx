      ...
      <Document>
        <Page style={styles.body} size="A4">
          <View fixed style={[styles.header, styles.flex]}>
            <View style={{ width: "20%" }}>
              <Image style={styles.logo} src="/headers/philhealth_logo.png" />
            </View>
            <View style={{ width: "80%", position: "relative", height: 70 }}>
              <Text style={[styles.title, styles.boldFont]}>
                Request for Records Storage Form
              </Text>
          ...
          <Text style={{ fontSize: 10, padding: 5 }}>
            Note: The Records Section shall not be responsible for any loss of
            the box's contents.
          </Text>
          {/* Prepared by */}
          <View wrap={false} style={{ marginTop: 10 }}>
            ...
            <View style={styles.flex}>
              <View style={[styles.border, styles.tableCell, { width: "55%" }]}>
                ...
                <Text style={styles.signatoryPosition}>
                  Document Custodian, {data.data.office}
                </Text>
              </View>
              <View style={[styles.border, styles.tableCell, { width: "50%" }]}>
          ...
          <View wrap={false}>
            <View style={styles.flex}>
              <Text
                style={[styles.signatoryFor, styles.border, { width: "55%" }]}
              >
                Requesting Officer:
              </Text>
              <Text
            ...
            <View style={styles.flex}>
              ...
              <View style={[styles.border, styles.tableCell, { width: "35%" }]}>
                <Text style={styles.signatoryName}>MARY KAY J. UY</Text>
              </View>
              <View style={[styles.border, styles.tableCell, { width: "20%" }]}>
                <Text></Text>
              </View>
