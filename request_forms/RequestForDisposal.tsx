...
export default function RequestForDisposal (props) {
  const { data } = props;
        ...
        <Page style={styles.body} size="A4">
          <View fixed style={[styles.header, styles.flex]}>
            ...
            <View style={{width: '80%', position: 'relative', height: 70}}>
              <Text style={[styles.title, styles.boldFont]}>Request for Records Disposal Form</Text>
              <Text style={styles.formNo}>PHILHEALTH-QP-02-F04</Text>
            </View>
          </View>
          ...
          <Text style={styles.letterBody}>Please dispose the following records.</Text>
          ...
          {/* Table Header */}
              ...
              <View style={styles.flex}>
                ...
                <View style={[styles.border,styles.tableHeader,{width: '10%'}]}>
                  <Text>RDS No.</Text>
                </View>
                ...
                <View style={[styles.border,styles.tableHeader,{width: '13%'}]}>
          ...
          {/* Table Body */}
          {
            data.data.details.map((box)=>(
              ...
              <View style={styles.flex}>
                ...
                <View style={{flexDirection: 'column', width: '69.1%'}}>
                {
                  JSON.parse(box.box_details).map((details)=>(
                    <React.Fragment>
                    <View style={styles.flex}>
                      <View style={[styles.noTopBottomBorder,styles.tableCell,{width: '14.44%'}]}>
                            <Text>{details.rds_number}</Text>
                      </View>
                      <View style={[styles.noTopBottomBorder,styles.tableCell,{width: '64.96%'}]}>
                            <Text>{details.document_title}</Text>
                            <Text>{details.description}</Text>
                      </View>
                      <View style={[styles.noTopBottomBorder,styles.tableCell,{width: '21.6%'}]}>
                    ...
                    <View style={styles.flex}>
                    <View style={[styles.bottomBorder,styles.tableCell,{width: '14.44%'}]}>
                    </View>
                    <View style={[styles.bottomBorder,styles.tableCell,{width: '64.96%'}]}>
                      {
                        box.remarks&& (
                          <React.Fragment>
                    ...
                    <View style={[styles.bottomBorder,styles.tableCell,{width: '21.6%'}]}>
                    </View>
                    </View>
                </View>
                <View style={[styles.border,styles.tableCell,{width: '13%'}]}>
          ...
          Note: This is to certify that the aforementioned records are neither needed nor involved in any administrative, financial and/or judicial cases.
          </Text>
          {/* Prepared by */}
