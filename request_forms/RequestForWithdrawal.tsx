...
export default function RequestForWithdrawal (props) {
  const { data } = props;
        ...
        <Page style={styles.body} size="A4">
          <View fixed style={[styles.header, styles.flex]}>
            ...
            <View style={{width: '80%', position: 'relative', height: 70}}>
              <Text style={[styles.title, styles.boldFont]}>Request for Records Withdrawal Form</Text>
              <Text style={styles.formNo}>PHILHEALTH-QP-02-F02</Text>
            </View>
          </View>
          ...
          <Text style={styles.rsfno}>RWF No.:   <Text style={{textDecoration: 'underline'}}>{data.data.form_no}</Text></Text>
          ...
          <Text style={styles.letterBody}>May we request for withdrawal/pull-out of the following records.</Text>
